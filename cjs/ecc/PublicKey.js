...
class PublicKey {
     ...
     */
    static fromPublicKeyString(public_key, address_prefix = "TREC") {
        try {
     ...
     *   @return PublicKey
     */
    static fromStringOrThrow(public_key, address_prefix = "TREC") {
